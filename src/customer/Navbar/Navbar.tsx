                ...
                <div className="flex items-center justify-between px-5 lg:px-12 h-[60px] border-b border-gray-200">
                    <div className="flex items-center gap-3">
                        <div className="flex items-center gap-2">
                            ...
                            <h1 className="logo text-[18px] font-bold">MM Fashion World</h1>
                        </div>
                        {/* menu */}
                    ...
                    <div className="flex items-center gap-1">
                        ...
                        {false?<Button className="flex gap-1 items-center" ><Avatar src="https://res.cloudinary.com/dpd5xwjqp/image/upload/v1752324558/products/gt2pout8feanpscvl9ev.jpg" sx={{width:25, height:25}}/><h2>MM Fashion</h2></Button>:<Button variant="contained" size="small" startIcon={<AccountCircle/>}>
                            Login
                        </Button>}
                         <IconButton>
